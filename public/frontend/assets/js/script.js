...
(function($) {
    ...
    $(document).on('click','.menu-bar-icon',function (){
        ...
        $('.settings-menu-container').toggle();
    });

    $( window ).resize(function() {
      let windowWidth = $(window).width();
      console.log(windowWidth);
        let dataShow = $('.menu-bar-icon').attr('data-show');

      if(windowWidth < 768){
          if(dataShow == '1'){
              $('.menu-bar-icon').attr('data-show','0');
              $('.menu-bar-icon').html(`<i class="fa fa-bars" aria-hidden="true"></i>`);
          }
          ...
          if(dataShow == '0'){
              $('.menu-bar-icon').attr('data-show','1');
              $('.menu-bar-icon').html(`<i class="fa fa-times" aria-hidden="true"></i>`);
          }
