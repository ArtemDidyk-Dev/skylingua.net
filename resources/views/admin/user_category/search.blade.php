                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover table-striped" data-sorting="true">
                        ...
                        @foreach($user_categories as $user_category)
                            <tr class="table-id-{{ $user_category->id }}" data-index="{{ $user_category->id }}" data-position="{{ $user_category->sort }}">
                               <!-- ID -->
                                <td>{{$user_category->id}}</td>

                                <!--  NAME  -->
                                <td><a href="{{ route('admin.user_category.edit',$user_category->id) }}">{{ $user_category->name }}</a></td>
                                ...
                                <!--  Tarix  -->
                                <td>{{ \Illuminate\Support\Carbon::parse($user_category->updated_at)->format('Y-m-d H:i') }}</td>
                ...
                <div class="card-footer">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="d-flex flex-wrap py-2 mr-3">
                            {{ $user_categories->appends(['search' => request('search')])
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        Swal.fire({
                            title: "Attention?",
                            html: "Are you sure you want to delete User Category?",
                            icon: "error",
