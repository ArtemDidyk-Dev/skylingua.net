            ...
            <div class="row">
                <div class="col-my-lg-8 ">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <!--begin::Card body-->
                        <div class="card-body">
                            <form class="form" id="submit-form" action="{{ route('admin.user_category.store') }}"
                                  method="POST"
                            >
                                @csrf
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="radio-list">
                                    <label class="radio">
                                        <input form="submit-form"  type="radio" {{ old('role_id') == 3 ? 'checked' : null }} name="role_id" value="3">
                                        <span></span>Employer</label>
                                    <label class="radio">
                                        <input form="submit-form" type="radio" {{ old('role_id') == 4 ? 'checked' : null }} name="role_id" value="4">
