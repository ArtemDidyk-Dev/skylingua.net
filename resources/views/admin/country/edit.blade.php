            ...
            <div class="row">
                <div class="col-my-lg-8 ">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-header card-header-tabs-line nav-tabs-line-3x">
                            ...
                            <div class="card-toolbar">
                                <ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
                                    ...
                                    <!--begin::Item-->
                                    <li class="nav-item mr-3">
                                        <a class="nav-link" data-toggle="tab" href="#tab-country-seo">
                        ...
                        <!--begin::Card body-->
                        <div class="card-body">
                            <form class="form" id="submit-form" action="{{ route('admin.country.update') }}"
                                  method="POST"
                            >
                                @csrf
                                ...
                                <div style="padding-top: 0" class="tab-content">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                value="{{ old('name.'. $language->id,getTranslateData($country->CountriesTranlations,$language->id,'name')) }}"
                                                                                class=" form-control">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea
                                                                                ...
                                                                                class="tinymceEditor form-control">{{ old('text.'. $language->id,getTranslateData($country->CountriesTranlations,$language->id,'text')) }}</textarea>
                                    ...
                                    <!--begin::Tab-->
                                    <div class="tab-pane " id="tab-country-seo" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                value="{{ old('title.'. $language->id,getTranslateData($country->CountriesTranlations,$language->id,'title')) }}"
                                                                                class=" form-control">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                value="{{ old('keyword.'. $language->id,getTranslateData($country->CountriesTranlations,$language->id,'keyword')) }}"
                                                                                class=" form-control">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea
                                                                                ...
                                                                                class=" form-control">{{ old('description.'. $language->id,getTranslateData($country->CountriesTranlations,$language->id,'description')) }}</textarea>
                                                                    ...
                                                                    @foreach(cache('key-all-languages') as $key => $language)
                                                                        <div class="input-group mt-2">
                                                                            ...
                                                                            <input
                                                                                style="height: 21px;"
                                                                                type="text" readonly
                                                                                value="{{$language->code == cache('language-default') ? "": "/".$language->code}}/country/{{ $country->slug }}"
                                                                                class="form-control">
                                                                        </div>
                ...
                <div class="col-my-lg-4 ">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <!--  ID  -->
                            <input type="hidden" form="submit-form" name="id" value="{{ $country->id }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select form="submit-form" class="form-control" name="status">
                                        ...
                                        <option {{ $country->status == 0?'selected':'' }} value="0">Passive</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="save-tools-item">
                                        <div>Create date:</div>
                                        <div>{{ \Illuminate\Support\Carbon::parse($country->created_at)->format('Y-m-d H:i') }}</div>
                                    </div>
                                    <div class="save-tools-item">
                                        <div>Update date:</div>
                                        <div>{{ updateDate($country->updated_at,$country->CountriesTranlations) }}</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12 ">
                                    ...
                                    <div
                                        ...
                                        <div class="images-post-item">
                                            ...
                                            <div
                                                style="display: {{ old('image',$country->image) == null? 'none':'flex' }}"
                                                tooltip="Delete"
                                            ...
                                            >
                                                ...
                                                <img
                                                    src="{{old('image',$country->image) == null ? asset('storage/no-image.png'): old('image',$country->image) }}"
                                                    class="previewImage"
                                                >
