    ...
    <div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <!--begin::Countries Heading-->
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Countries Title-->
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        @isset($searchText)
                            <li class="breadcrumb-item">
                                <a href="{{ route('admin.language.index') }}" class="text-muted">Countries</a>
                            </li>
                            <li class="breadcrumb-item">
                                Search
                            </li>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover table-striped" data-sorting="true">
                        ...
                        @foreach($countries as $country)
                            <tr class="table-id-{{ $country->id }} sortableHandle" data-index="{{ $country->id }}" data-position="{{ $country->sort }}">
                               <!-- ID -->
                                <td>{{$country->id}}</td>
                                ...
                                <!--  Tarix  -->
                                <td>{{ updateDate($country->updated_at,$country->CountriesTranlations) }}</td>
                ...
                <div class="card-footer">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="d-flex flex-wrap py-2 mr-3">
                            {{ $countries->appends(['search' => isset($searchText) ? $searchText : null])
...
@section('js')
    ...
    <script>
        ...
        function saveNewPositions() {
            ...
            $.ajax({
                url: "{{ route('admin.country.sortAjax') }}",
                method: 'POST',
                dataType: 'JSON',
