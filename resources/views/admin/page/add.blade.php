            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.page.index') }}" class="text-muted">Pages</a>
                        </li>
                                                            ...
                                                            <div class="tab-content">
                                                                ...
                                                                @foreach(cache('key-all-languages') as $key => $language)
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <!--  TITLE START  -->
                                                                        <div class="form-group">
                                                                            <span class="span-dvidder">Meta Title ({{ $language->code }})</span>
                                                                            <input
                                                                                type="text"
                                                                        ...
                                                                        <!--  KEYWORD START  -->
                                                                        <div class="form-group">
                                                                            <span class="span-dvidder">Meta Keywords ({{ $language->code }})</span>
                                                                            <input
                                                                                type="text"
                                                                        ...
                                                                        <!--  DESCRIPTION START  -->
                                                                        <div class="form-group">
                                                                            <span class="span-dvidder">Meta Description ({{ $language->code }})</span>
                                                                            <textarea
                                                                                rows="6"
                                                                                type="text"
