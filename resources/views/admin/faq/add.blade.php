                ...
                <div class="col-my-lg-8 ">
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 ">
                                    <form class="form" id="submit-form" action="{{ route('admin.faq.store') }}" method="POST" >
                                        @csrf
                                        <div class="card-body">
                                            <div class="mb-15">
                                                <!--  Title  -->
                                                <div class="form-group row form-name">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input id="name" type="text" name="title" value="{{ old('title') }}" class="form-control form-control-lg" placeholder="Title"/>
