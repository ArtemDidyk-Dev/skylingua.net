                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="card-label">Add Subscriber</h3>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 ">
                                    <form class="form" id="submit-form" action="{{ route('admin.subscriber.store') }}" method="POST" >
                                        @method('post')
                                        @csrf
                                        <div class="card-body">
                                            <div class="mb-15">
                                                ...
                                                <div class="form-group row form-name">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input id="name" type="text" name="name" value="{{ old('name') }}" class="form-control form-control-lg" placeholder="name" required/>
