            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a class="text-muted">Subscriber</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">Subscriber</h3>
                    </div>
                    <div class="card-toolbar">

                        <a href="{{ route('admin.subscriber.create') }}">
                            <button tooltip="Add Subscriber" flow="left"
                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover table-striped" data-sorting="true">
                        ...
                        <tr>
                            ...
                            <th data-breakpoints="">User Name</th>
                            <th width="40" data-breakpoints="xs sm md" data-sortable="false">Settings</th>
                        </tr>
                        </thead>
                        <tbody id="sortable">
                        @foreach ($subscribers as $subscriber)
                            <tr class="table-id-{{ $subscriber->id }}" data-index="{{ $subscriber->id }}">
                                <!--  ID  -->
                                <td>{{ $subscriber->id }}</td>
                                <!--  Service NAME  -->
                                <td>
                                        ...
                                        <div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right"
                                            ...
                                            <ul class="navi navi-hover">
                                                ...
                                                <li class="navi-item">
                                                    ...
                                                    <a href="{{ route('admin.subscriber.edit', $subscriber) }}"
                                                ...
                                                <li class="navi-item deleteButton" data-id="{{ $subscriber->id }}">
