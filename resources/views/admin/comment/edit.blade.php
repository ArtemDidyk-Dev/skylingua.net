                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="card-label">Edit Comment</h3>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 ">
                                    <form class="form" id="submit-form" action="{{ route('admin.comment.update', $comment) }}" method="POST"  enctype="multipart/form-data" >
                                        @csrf
                                        <div class="card-body">
                                            <div class="mb-15">
                                                <!--  Title  -->
                                                    ...
                                                    <div class="col-lg-6 form-group row form-name">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input id="descrip" type="text" name="descrip"
                                                                   value="{{ old('descrip',  $comment->descrip) }}"
                                                                   class="form-control form-control-lg"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea style="margin-top: 20px; min-height: 100px"
                                                              type="text"
                                                              name="content"
                                                              class="tinymceEditor form-control">{{ old('content', $comment->content)}}</textarea>
                                                    @error('content')<span
                                        ...
                                        <div class="crop-photo-container">
                                            ...
                                            <div class="cabinet center-block">
                                                ...
                                                <figure>
                                                    <img
                                                        src="{{ old('image', $comment->image) ? asset(old('image', "storage/".$comment->image)) : asset('storage/no-image.png') }}"
