            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.payout.index') }}" class="text-muted">Pay Out</a>
                        </li>
                        <li class="breadcrumb-item">
                            @if(isset($payOuts[0]->user_name)) {{ $payOuts[0]->user_name }} @endif
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">Pay Out @if(isset($payOuts[0]->user_name)) ({{ $payOuts[0]->user_name }}) @endif</h3>
                    </div>
...
{{--                                <td>{{$payOut->id}}</td>--}}
                                ...
                                <!-- Name -->
                                <td>{{ $payOut->user_name }} ({{ $payOut->user_email }})</td>
                                  <!-- Type -->
                                  <td>
                                      @if($payOut->type == 1)
                                          Card
                ...
                <div class="card-footer">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="d-flex flex-wrap py-2 mr-3">
                            {{ $payOuts->appends(['search' => request('search')])
