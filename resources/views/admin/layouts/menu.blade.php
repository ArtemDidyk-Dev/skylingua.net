<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto" id="kt_brand">
        ...
        <a href="{{ route('admin.index') }}" class="brand-logo">
            <img alt="Logo" width="80" height="36" src="/images/admin-logo.png"/>
        </a>
        <!--end::Logo-->
        <!--begin::Toggle-->
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                <!--  faq  -->
                <li class="menu-item menu-item-submenu {{ Route::is(['admin.faq.index']) ? 'menu-item-open' : '' }}"
                    aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <span
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            <!--  Users  -->
                            <li class="menu-item {{ Route::is(['admin.faq.index']) ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                            ...
                            <li class="menu-item {{ Route::is(['admin.faq.add']) ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{ route('admin.faq.create') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">Add Faq Element</span>
                                </a>
                            </li>
                ...
                <!--  Comment -->
                <li class="menu-item menu-item-submenu {{ Route::is(['admin.comment.index']) ? 'menu-item-open' : '' }}"
                    aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <span
                            class="svg-icon menu-icon"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Communication/Address-card.svg--><svg
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            <!--  Users  -->
                            <li class="menu-item {{ Route::is(['admin.comment.index']) ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                            ...
                            <li class="menu-item {{ Route::is(['admin.comment.add']) ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
                                <a href="{{ route('admin.comment.create') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">Add Comment Element</span>
                                </a>
                            </li>
