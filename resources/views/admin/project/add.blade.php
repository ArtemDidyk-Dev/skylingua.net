            ...
            <div class="row">
                <div class="col-my-lg-8 ">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <!--begin::Card body-->
                        <div class="card-body">
                            <form class="form" id="submit-form" action="{{ route('admin.project.store') }}"
                                                                ...
                                                                @foreach(cache('key-all-languages') as $key => $language)
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="projectUserNameResult" @if(old('user_name') != null) style="display: block" @endif >@if(old('user_name') != null)
                                                                                @if(\App\Services\UserService::getUserNameEmail(old('user_name')) != null){{ \App\Services\UserService::getUserNameEmail(old('user_name'))->name }}@endif
                                                                                    @if(\App\Services\UserService::getUserNameEmail(old('user_name')) != null)({{ \App\Services\UserService::getUserNameEmail(old('user_name'))->email }})@endif
                                                                                @endif</div>
                                                                            <input
                                                                                id="projectUserID"
                                                                                type="hidden"
                                                                        ...
                                                                        <!--  Pricing START  -->
                                                                        <div class="form-group" id="price_project" @if(old('price_type')!=1 && old('price_type')!=2) style="display: none;" @endif>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="input-group input-group-solid date" id="kt_datetimepicker_3" data-target-input="nearest">
                                                                                    <input type="text" class="form-control form-control-solid datetimepicker-input" name="deadline" value="{{ old('deadline') }}" placeholder="Select period of Project" data-target="#kt_datetimepicker_3" />
															...
															<span class="input-group-text">
																<i class="ki ki-calendar"></i>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea
                                                                                name="description"
                                                                                class="tinymceEditor form-control">{{ old('description') }}</textarea>
                                                                            @error('description')
                                                                            <div class="text-danger mt-2">{{ $message }}</div>
                                                                            @enderror
                                                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select form="submit-form" class="form-control" name="status">
                                        ...
                                        <option {{ old('status') == 2 ? 'selected' : '' }} value="2">Pending</option>
                                        <option {{ old('status') == 3 ? 'selected' : '' }} value="3">Ongoing</option>
                                        <option {{ old('status') == 4 ? 'selected' : '' }} value="4">Completed</option>
                                        <option {{ old('status') == 5 ? 'selected' : '' }} value="5">Canceled</option>
                                    </select>
                                </div>
                            </div>
