...
@section('content')
    ...
    <!--begin::Entry-->
    <div class="d-flex flex-column-fluid" x-data="course()">
        <!--begin::Container-->
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="form-group row form-user_category">
                                                                        <label for="user_category"
                                                                            ...
                                                                            User</label>
                                                                        <div class="col-lg-4">
                                                                            <select required class="form-control" name="user" x-model="formData.user">
                                                                                <template x-for="user in users" :key="user.id">
                                                                                    <option :value="user.id" x-text="user.name" :selected="user.id == formData.user"></option>
                                                                                </template>
                                                                            </select>
...
@section('js')
    ...
    <script>
        ...
        function course() {
            return {
                users: @json($users),
                link: "{{route('admin.courses.update', $course->id)}}",
                errors: '',
