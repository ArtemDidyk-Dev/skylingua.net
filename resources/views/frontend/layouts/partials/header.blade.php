        ...
        <div class="header__inner">
            <div class="header__logo">
                <a href="{{ route('frontend.home.index') }}" class="header__logo-img">
                    <img width="110" src="{{ asset('build/website/images/logo.png') }}"
                         alt="logo">
                </a>
            </div>
                        ...
                        @if (auth()->check())
                            ...
                            <div class="header-profile">
                                <div class="header-profile__wrapper">
                                    <span class="user-img">
                                        <img
                                            src="{{ !empty(auth()->user()->profile_photo) ? asset('storage/profile/' . auth()->user()->profile_photo) : asset('storage/no-photo.jpg') }}"
                                            alt="{{ auth()->user()->name }}">
                                    </span>
