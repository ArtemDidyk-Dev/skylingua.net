                ...
                <div class="col-xl-9 col-md-8">
                    <div class="portfolio-item">
                        <div class="pro-head p-0 pb-2">
                            <h3 class="mb-0">{{ language('Courses Create') }}</h3>
                        </div>
                            ...
                            <div class="row">
                                <div >
                                    <form @submit.prevent="submit()" class="form" id="submit-form"
                                          action="{{ route('frontend.dashboard.freelancer.courses.add.store') }}"
                                          method="POST">
                                        <div >
                                            <!--begin::Tab-->
                                                                ...
                                                                <div class="col-md-12 ">
                                                                    <div >
                                                                        <div
                                                                            ...
                                                                            <div class="form-group">
                                                                                <span
                                                                                    class="span-dvidder">Description </span>
                                                                                <textarea
                                                                                    type="text"
                                                                                    name="text"
                                                                            ...
                                                                            <div class="form-group">
                                                                                <span
                                                                                    class="span-dvidder">Upload Files</span>
                                                                                <template
...
@section('JS')
    ...
    <script>
        ...
        function course() {
            return {
                link: "{{route('frontend.dashboard.freelancer.courses.add.store')}}",
